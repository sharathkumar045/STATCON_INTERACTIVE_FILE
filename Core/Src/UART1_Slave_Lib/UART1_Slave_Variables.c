...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ...
   // variables related to UART1_Rec_Transmission
      ...
      __IO unsigned char UART1_recvdata[200]={0};
      
      const uint8_t UART1_crcTable[256]={0,7,14,9,28,27,18,21,56,63,54,49,36,35,42,45,112,119,126,121,
      ...
      struct U1_Rec_Flags UART1_Rec_Flags;


      struct U1_Rec_Var UART1_Rec_Var;
...
//UART1 variables related to message sending
       ...
       struct U1_Send_Flags UART1_Send_Flags;

       struct U1_Send_Var UART1_Send_Var;

  
   
     
       struct U1_Msg_Send_Reqt_Flags UART1_Msg_Send_Reqt_Flags;

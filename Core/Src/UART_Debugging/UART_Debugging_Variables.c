...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
      __IO unsigned char UART_Debugging_recvdata[200]={0};
      
      const uint8_t UART_Debugging_crcTable[256]={0,7,14,9,28,27,18,21,56,63,54,49,36,35,42,45,112,119,126,121,
      ...
      struct U_Rec_Flags UART_Debugging_Rec_Flags;


      struct U_Rec_Var UART_Debugging_Rec_Var;
...
//UART_Debugging variables related to message sending
       ...
       __IO unsigned char UART_Debugging_Txdata[500]={0};



       struct U_Send_Flags UART_Debugging_Flags;

       struct U_Send_Var UART_Debugging_Var;

  
   
     
       struct U_Msg_Send_Reqt_Flags UART_Debugging_Msg_Send_Reqt_Flags;
     
// 		variables which can be transfered to user variables.c
//      __IO uint8_t  D_Mode=0;
//      __IO uint16_t D_M1S1_activation_State=0;
//      __IO uint16_t D_M1S1Steps=0;
//      __IO uint16_t D_M1S1Speed=0;
//      __IO uint16_t D_M1S1Direction=0;

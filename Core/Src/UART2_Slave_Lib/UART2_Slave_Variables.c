...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ...
   // variables related to UART1_Rec_Transmission
      ...
      __IO unsigned char UART2_recvdata[200]={0};
      
      const uint8_t UART2_crcTable[256]={0,7,14,9,28,27,18,21,56,63,54,49,36,35,42,45,112,119,126,121,
      ...
      struct U2_Rec_Flags UART2_Rec_Flags;


      struct U2_Rec_Var UART2_Rec_Var;
...
//UART1 variables related to message sending
       ...
       __IO unsigned char UART2_Txdata[90]={0};



       struct U2_Send_Flags UART2_Send_Flags;

       struct U2_Send_Var UART2_Send_Var;

  
   
     
       struct U2_Msg_Send_Reqt_Flags UART2_Msg_Send_Reqt_Flags;
